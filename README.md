...
&nbsp;&nbsp;단국대학교 죽전캠퍼스 소프트웨어학과
### GitHub 주소     
&nbsp;&nbsp; https://github.com/jenny2e

### 이메일  
  + 개인 - jenny2e@naver.com    
  + 학교 - jenny2e@dankook.ac.kr
...
### 도구 (Tools)
- **VS Code** - 주 개발 환경  
- **Jupyter Notebook / Google Colab** - 데이터 실험, 시각화, ML 모델 테스트에 사용하며, 보다 빠른 서버 환경을 위해 자주 사용
- Linux / Ubuntu   
- Git / GitHub 
- Notion - 개인 학습 정리와 협업 도구로 가장 많이 사용
